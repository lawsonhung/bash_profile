...
# App secrets
export delightful_texts_jwt_secret='badbreathbuffalo'
...
__conda_setup="$('/Users/lawsonhung/opt/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/Users/lawsonhung/opt/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/Users/lawsonhung/opt/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/Users/lawsonhung/opt/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
